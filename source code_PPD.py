    ...
    if epds_col and age_col and days_col:
        ...
        if len(X) == 0 or len(y) == 0:
            ...
            if high_risk_df.empty:
                ...
                SMTP_USER = st.secrets["ppdwellbeings@gmail.com"]["support ppdwellbeing"]
                SMTP_PASS = st.secrets["ppdwellbeings@gmail.com"]["Ganesh@1979"]
                ...
                try:
                    ...
                    server.sendmail(SMTP_USER, ["ppd.alerts.system@gmail.com"], msg.as_string())
                                                server.quit()
